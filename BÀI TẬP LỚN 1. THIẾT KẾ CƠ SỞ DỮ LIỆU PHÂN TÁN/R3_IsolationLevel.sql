...
CREATE DATABASE LINK GD_CN01 CONNECT TO Manager IDENTIFIED BY GUEST USING 'CN01_LINK'
...
-- CN02:
COMMIT;
SELECT * FROM CN01.CUSTOMER_INFO WHERE CustomerID = 'CUS01';
...
-- CN02:
COMMIT;
SELECT * FROM CN01.CUSTOMER_INFO WHERE CustomerID = 'CUS40';

-- ///// UNREPEATABLE READ 
-- ///// UNREPEATABLE READ 
-- ///// UNREPEATABLE READ 
-- CN02: SELECT * FROM CN01.CUSTOMER_INFO WHERE CustomerID = 'CUS11';
BEGIN
...
-- /// GIẢI PHÁP
-- /// GIẢI PHÁP
-- CN02: SELECT * FROM CN01.CUSTOMER_INFO WHERE CustomerID = 'CUS04';
SET TRANSACTION ISOLATION LEVEL SERIALIZABLE;
BEGIN
...
-- CN02:
SELECT * FROM CN01.MENU WHERE MenuType = 'Banh Ngot';
SELECT * FROM CN01.MENU WHERE MenuType = 'Tra Sua';
-- /// GIẢI PHÁP
-- /// GIẢI PHÁP
-- CN02:
SET TRANSACTION ISOLATION LEVEL SERIALIZABLE;
...
COMMIT;
-- CN02:
SELECT * FROM CN01.MENU WHERE MenuType = 'Ca Phe Italy';
SELECT * FROM CN01.MENU WHERE MenuType = 'Tra';


INSERT INTO CN01.MENU VALUES ('ME64','Pudding','X-mas',40000);
